...
import { setState, setDemoHandler, idleState } from './state.js?v=0.6.1';
import { mountFab, unmountFab, resetFabPosition } from './ui/fab.js?v=0.6.1';
import { mountMenuItem, unmountMenuItem } from './ui/menu.js?v=0.6.1';
import {
    mountPanel,
    unmountPanel,
    togglePanel,
    ...
    refreshPrompts,
} from './ui/panel.js?v=0.6.1';
import { diagnose, probe, exposeGlobals } from './diagnostics.js?v=0.6.1';
import { getSettings, saveSettings, DEFAULT_CRITIC_PROMPT, DEFAULT_REWRITE_PROMPT } from './config.js?v=0.6.1';
import { runPipeline, findLastAssistantIndex, extractReasoning, recoverSlots } from './pipeline.js?v=0.6.1';
import { probeTavernHelper, getProxyPresets } from './tavern.js?v=0.6.1';
