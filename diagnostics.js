...
import { log, setDiagOutput } from './ui/panel.js?v=0.5.0';
import { describeMenuContainer, isMenuItemMounted } from './ui/menu.js?v=0.5.0';
...
export async function showLastRequests() {
    ...
    let snapshot;
    try {
        const mod = await import('./pipeline.js?v=0.5.0');
